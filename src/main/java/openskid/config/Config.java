...
public class Config {
    ...
    public Config(String name, boolean newConfig) {
        ...
        this.file = new File("./config/OpenSkid/", String.format("%s.json", this.name));
        try {
    ...
    public void load() {
        try {
            ...
            if (!file.exists()) {
                ChatUtil.sendFormatted(String.format("%sConfig file not found (&c&o%s&r). Creating default config...&r", OpenSkid.clientName, file.getName()));
                save();
                return;
            }
            ...
            ChatUtil.sendFormatted(String.format("%sConfig has been loaded (&a&o%s&r)&r", OpenSkid.clientName, file.getName()));
        } catch (FileNotFoundException e) {
            ChatUtil.sendFormatted(String.format("%sConfig file not found (&c&o%s&r)&r", OpenSkid.clientName, file.getName()));
        } catch (JsonSyntaxException e) {
            ChatUtil.sendFormatted(String.format("%sConfig has invalid JSON syntax (&c&o%s&r)&r", OpenSkid.clientName, file.getName()));
            ...
            ChatUtil.sendFormatted(String.format("%sConfig couldn't be loaded (&c&o%s&r)&r", OpenSkid.clientName, file.getName()));
        }
    }
    ...
    public void save() {
        try {
            ...
            ChatUtil.sendFormatted(String.format("%sConfig couldn't be saved (&c&o%s&r)&r", OpenSkid.clientName, file.getName()));
        }
    }
}
