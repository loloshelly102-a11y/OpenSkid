...
public class BedESP extends Module {
    ...
    private int getColor() {
        switch (this.color.getValue()) {
            ...
            case 1:
                return ((HUD) OpenSkid.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis());
            default:
                return -1;
        }
    }
    ...
    public BedESP() {
        super("BedESP", false, false, "Highlights beds and obsidian covers through walls.");
