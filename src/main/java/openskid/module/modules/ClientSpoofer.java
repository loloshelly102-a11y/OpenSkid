...
public class ClientSpoofer extends Module {
    ...
    private static final String[] MODES = new String[]{
            ...
            "Geyser", "FDP", "OpenSkid", CUSTOM_MODE
    };
    private static final String[] BRAND_VALUES = new String[]{
            ...
            "Geyser", "FDPClient", "OpenSkid", ""
    };

    public final ModeProperty mode = new ModeProperty("mode", 0, MODES);
    public final TextProperty customBrand = new TextProperty("custom-brand", "OpenSkid", this::isCustomMode);

    public ClientSpoofer() {
        super("ClientSpoofer", false, false, "Spoofs your client brand sent to servers.");
    }
