...
import openskid.mixin.IAccessorC0DPacketCloseWindow;
...
// Sprint owns the sprint key. InvWalk only preserves physical key state while a GUI is open.
public class InvWalk extends Module {
    ...
    public InvWalk() {
        super("InvWalk", false, false, "Lets you move normally while an inventory is open.");
    }
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (mc.currentScreen instanceof openskid.ui.ClickGui && this.guiEnabled.getValue()) {
