...
public class AutoAnduril extends Module {
    ...
    public AutoAnduril() {
        super("AutoAnduril", false, false, "Swaps to your Anduril sword on an interval then swaps back.");
    }
    ...
    public boolean canSwap() {
        ...
        InvWalk invWalk = (InvWalk) OpenSkid.moduleManager.modules.get(InvWalk.class);
        return mc.currentScreen == null || mc.currentScreen instanceof openskid.ui.ClickGui
