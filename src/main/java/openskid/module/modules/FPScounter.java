...
import openskid.util.render.BlurShadowRenderer;
...
public class FPScounter
    ...
    public FPScounter() {
        super("Fpscounter", false, false, "Displays your current FPS in a movable overlay.");
    }
    ...
    public void onRender2DEvent(Render2DEvent event) {
        ...
        if (blur > 0) {
            openskid.util.shader.ShadowShader.drawShadow(rectX, rectY, w, h, radius, blur * 2.0f, ((Math.min(255, alpha)) << 24) | 0x000000);
        }
        
        openskid.util.RoundedUtils.drawRoundedRect(rectX, rectY, w, h, radius, ((Math.min(255, alpha)) << 24) | 0x000000);
