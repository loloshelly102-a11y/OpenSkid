...
import openskid.mixin.IAccessorKeyBinding; // Import IAccessorKeyBinding
...
public class AutoGapple extends Module {
    ...
    public AutoGapple() {
        super("Gapple", false, false, "Automatically eats golden apples when health is low."); // Name, default enabled (false), default hidden (false)
    }
    ...
    public void onTick(TickEvent event) {
        ...
        if (!isEating) {
            if (!eatInCombat.getValue() && OpenSkid.playerStateManager.isInCombat()) {
