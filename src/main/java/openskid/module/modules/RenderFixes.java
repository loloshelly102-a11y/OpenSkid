...
public class RenderFixes extends Module {
    ...
    public RenderFixes() {
        super("RenderFixes", true, false, "Improves chat and scoreboard with modern rounded rendering.");
    }
    ...
    public static RenderFixes get() {
        ...
        Module module = OpenSkid.moduleManager.getModule(RenderFixes.class);
