...
public class NameTags extends Module {
    ...
    public final ModeProperty distanceMode = new ModeProperty("distance", 0, new String[]{"NONE", "DEFAULT", "NOVA"}, () -> this.mode.getValue() == 0);
    ...
    public NameTags() {
        super("NameTags", false, true, "Shows enhanced nametags with health and armor.");
    }
                ...
                if (!StringUtils.isBlank(EnumChatFormatting.getTextWithoutFormattingCodes(teamName))) {
                    ...
                    if (entity instanceof EntityPlayer) {
                        ...
                        if (TeamUtil.isFriend((EntityPlayer) entity)) {
                            ...
                            int friendColor = OpenSkid.friendManager.getColor().getRGB();
                            ...
                            float x2 = (float) width / 2.0F + 1.0F;
                            float off = this.shadow.getValue() ? 0.0F : -1.0F;
                            int targetColor = OpenSkid.targetManager.getColor().getRGB();
