...
public class AntiFireball extends Module {
    ...
    public AntiFireball() {
        super("AntiFireball", false, false, "Automatically attacks nearby fireballs to deflect them.");
    }
    ...
    public void onUpdate(UpdateEvent event) {
        if (this.isEnabled() && event.getType() == EventType.PRE) {
            ...
            if (TeamUtil.isEntityLoaded(fireball)) {
                ...
                if (!OpenSkid.playerStateManager.attacking && !OpenSkid.playerStateManager.digging && !OpenSkid.playerStateManager.placing) {
