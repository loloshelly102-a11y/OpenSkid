...
public class AutoBlockIn extends Module {
    ...
    public AutoBlockIn() {
        super("AutoBlockIn", false, false, "Automatically blocks yourself in with protective blocks.");
    ...
    public void onDisabled() {
        if (ScaffoldSessionState.hasSavedSlot(lastSlot) && mc.thePlayer != null && mc.thePlayer.inventory.currentItem != lastSlot) {
