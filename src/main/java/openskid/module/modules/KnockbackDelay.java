...
public class KnockbackDelay extends Module {
    ...
    public KnockbackDelay() {
        super("KnockbackDelay", false, false, "Delays knockback packets to reduce their effect.");
    }
    ...
    public void onPacket(PacketEvent event) {
        ...
        if (packet instanceof S07PacketRespawn || packet instanceof S40PacketDisconnect) {
            reset();
            return;
        }
