...
public class CFontRenderer extends CFont {
    ...
    public static Font getFontFromTTF(String fontFileName, float fontSize, int fontType) {
        ...
        ResourceLocation[] locations = new ResourceLocation[]{
                new ResourceLocation("openskid", "font/" + fontFileName),
                new ResourceLocation("openskid", "font/" + lowerCaseFileName),
        ...
        String[] classpathPaths = new String[]{
                "/assets/openskid/font/" + fontFileName,
                "/assets/openskid/font/" + lowerCaseFileName,
        ...
        System.err.println("[OpenSkid] Failed to load CFontRenderer font: " + fontFileName);
    ...
    private static void addDevFontFiles(Set<File> files, File start, String fontFileName, String lowerCaseFileName) {
        ...
        for (int i = 0; current != null && i < 8; i++) {
            files.add(new File(current, "src/main/resources/assets/openskid/font/" + fontFileName));
            files.add(new File(current, "src/main/resources/assets/openskid/font/" + lowerCaseFileName));
            files.add(new File(current, "assets/openskid/font/" + fontFileName));
            files.add(new File(current, "assets/openskid/font/" + lowerCaseFileName));
            current = current.getParentFile();
        }
    }
