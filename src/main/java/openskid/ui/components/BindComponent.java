...
import openskid.ui.dataset.BindStage;
...
public class BindComponent implements Component {
    ...
    public void draw(AtomicInteger offset) {
        ...
        this.renderText(displayText, ((HUD) OpenSkid.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis(), offset.get()));
        GL11.glPopMatrix();
    }
