...
public class CategoryComponent {
    ...
    public void render() {
        ...
        float middlePos = (float) (this.x + this.width / 2 - OpenSkid.fontManagers.getFont(20).getStringWidth(this.categoryName) / 2);
        ...
        if (!this.opened) {
            namePos = textTimer == null ? xPos : middlePos - textTimer.getValueFloat(0, this.width / 2 - OpenSkid.fontManagers.getFont(20).getStringWidth(this.categoryName) / 2 - 12, 1);
        }
        ...
        OpenSkid.fontManagers.getFont(20).drawString(this.categoryName, namePos, (float) (this.y + 2), categoryNameColor, false);
