...
public class ColorSliderComponent implements Component {
    ...
    private void drawLabel(int x, int y) {
        ...
        OpenSkid.fontManagers.getFont(24).drawString(text, x * 2, (parentModule.category.getY() + offsetY + 3) * 2, -1);
        GL11.glPopMatrix();
    }
    ...
    public void render() {
        ...
        GL11.glPushMatrix();
        GL11.glScaled(0.5, 0.5, 0.5);
        OpenSkid.fontManagers.getFont(24).drawString(property.getName(), x * 2, (y + 3) * 2, -1);
        GL11.glPopMatrix();
