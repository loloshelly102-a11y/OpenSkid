...
public class SliderComponent implements Component {
    ...
    public void draw(AtomicInteger offset) {
        ...
        Gui.drawRect(sliderStart, this.parentModule.category.getY() + this.offsetY + 11, sliderEnd, this.parentModule.category.getY() + this.offsetY + 15, ((HUD) OpenSkid.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis(), offset.get()));
        GL11.glPushMatrix();
        GL11.glScaled(0.5D, 0.5D, 0.5D);
        OpenSkid.fontManagers.getFont(24).drawStringWithShadow(this.slider.getName() + ": " + this.slider.getValueString(), (float) ((int) ((float) (this.parentModule.category.getX() + 4) * 2.0F)), (float) ((int) ((float) (this.parentModule.category.getY() + this.offsetY + 3) * 2.0F)), -1);
        GL11.glPopMatrix();
    }
    ...
    public void render() {
        ...
        GL11.glPushMatrix();
        GL11.glScaled(0.5D, 0.5D, 0.5D);
        OpenSkid.fontManagers.getFont(24).drawStringWithShadow(
