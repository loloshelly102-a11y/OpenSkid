...
import openskid.ui.impl.clickgui.legacy.dataset.BindStage;
...
public class BindComponent implements Component {
    ...
    public void draw(AtomicInteger offset) {
        ...
        this.renderText(this.isBinding ? BindStage.binding : BindStage.bind + ": " + Keyboard.getKeyName(this.parentModule.mod.getKey()), ((HUD) OpenSkid.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis(), offset.get()));
        GL11.glPopMatrix();
    }
    ...
    private void renderText(String s, int color) {
        OpenSkid.fontManagers.getFont(24).drawString(s, (float) ((this.parentModule.category.getX() + 4) * 2), (float) ((this.parentModule.category.getY() + this.offsetY + 3) * 2), color);
    }
    ...
    public void render() {
        ...
        OpenSkid.fontManagers.getFont(24).drawString(text,
