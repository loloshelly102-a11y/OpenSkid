...
public class ModeComponent implements Component {
    ...
    public void draw(AtomicInteger offset) {
        ...
        mode = mode.replace("_", " ");
        int bruhWidth = (int) (OpenSkid.fontManagers.getFont(24).getStringWidth(this.property.getName() + ": ") * 0.5);
        OpenSkid.fontManagers.getFont(24).drawString(this.property.getName() + ": ", (float) ((this.parentModule.category.getX() + 4) * 2), (float) ((this.parentModule.category.getY() + this.offsetY + 4) * 2), 0xffffffff, true);
        OpenSkid.fontManagers.getFont(24).drawString(ChatColors.formatColor("&9" + mode.substring(0, 1).toUpperCase() + mode.substring(1).toLowerCase()), (float) ((this.parentModule.category.getX() + 4 + bruhWidth) * 2), (float) ((this.parentModule.category.getY() + this.offsetY + 4) * 2), -1, true);
        GL11.glPopMatrix();
    }
