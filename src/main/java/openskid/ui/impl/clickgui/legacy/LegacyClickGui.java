package openskid.ui.impl.clickgui.legacy;
...
import openskid.ui.impl.clickgui.legacy.components.BindComponent;
import openskid.ui.impl.clickgui.legacy.components.CategoryComponent;
import openskid.ui.impl.clickgui.legacy.components.ModuleComponent;
...
public class LegacyClickGui extends GuiScreen {
    ...
    private static LegacyClickGui instance;
    private static boolean isNotFirstOpen;
    private final File configFile = new File("./config/OpenSkid/", "clickgui.txt");
    private final String clientName = "OpenSkid";
    private final String clientVersion = OpenSkid.version;
    ...
    public LegacyClickGui() {
        ...
        List<Module> combatModules = collect(
                ...
                LagRange.class, HitBox.class, MoreKB.class, Refill.class, HitSelect.class, JumpReset.class, BackTrack.class,
                Hitflick.class, TimerRange.class, ClickAssits.class, Criticals.class, BlockHit.class, AutoBlock.class,
                SprintReset.class, Displace.class, TickBase.class, Piercing.class, Stasis.class, SmartClicking.class, AutoRod.class,
                ForwardTrack.class, KeepRange.class, SmartBlinker.class, LegitReach.class, ProjectileAimBot.class, BurstClicker.class, ArmorBreaker.class);
        ...
        List<Module> renderModules = collect(
                ...
                WaterMark2.class, HitParticleEffects.class, KillEffect.class, KillSounds.class, DynamicIsland.class, ESP2D.class, TeamHealthDisplay.class,
                Statistics.class, Animations.class, BlockOverlay.class, Ambience.class, Capes.class, FreeLook.class, ItemPhysics.class,
                BedPlates.class, FKCounter.class, ClosestPlayerHUD.class, LeapModeHUD.class, MegaWallsDetector.class,
                FireBallPredict.class, DamageTags.class, TNTTimer.class, PotionHUD.class, Arrows.class, BlocksESP.class, MobESP.class, ItemTags.class, FallIndicator.class, InventoryHUD.class, KeyStrokes.class, EntityCulling.class);
        ...
        List<Module> miscModules = collect(
                ...
                Disabler.class, ClientSpoofer.class, ModSpoofer.class, ExploitFixer.class, AntiFalseFlag.class,
                GhostBlock.class, PingSpoof.class, AutoHypixel.class, MouseRawInput.class, BedwarUtils.class, AutoAuth.class,
                StaffDetector.class, MurderDetector.class, BedProximityAlert.class, CheatDetector.class,
    ...
    private final List<Module> collect(Class<? extends Module>... classes) {
        ...
        for (Class<? extends Module> c : classes) {
            Module m = OpenSkid.moduleManager.getModule(c);
            if (m != null) {
                list.add(m);
            }
        }
    ...
    public static LegacyClickGui getInstance() {
        return instance;
    }
        ...
        for (CategoryComponent c : categories) {
            ...
            for (Component m : c.getModules()) {
                if (m instanceof ModuleComponent) {
                    ((ModuleComponent) m).renderTooltip(x, y);
                }
            }
        }
    }
    ...
    private void onRenderTick(float partialTicks) {
        if (!clickGuiOpen && this.mc.currentScreen instanceof LegacyClickGui) {
            clickGuiOpen = true;
            initTimer(500.0F);
            startTimer();
            openedTime = System.currentTimeMillis();
        } else if (!(this.mc.currentScreen instanceof LegacyClickGui)) {
            clickGuiOpen = false;
        } else {
            int[] displaySize = {this.width, this.height};
            int y = displaySize[1] + (8 - getValueInt(0, 30, 2));

            OpenSkid.fontManagers.getFont(20).drawString(clientName + "-" + clientVersion, 4, y, hudColorCached, true);
            ...
            if (characterIndex < developer.length()) {
                ...
                OpenSkid.fontManagers.getFont(20).drawString(obfuscated, 4, y, hudColorCached, true);
            } else {
                OpenSkid.fontManagers.getFont(20).drawString(developer, 4, y, hudColorCached, true);
            }
        }
    }
