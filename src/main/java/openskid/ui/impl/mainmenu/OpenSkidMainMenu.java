package openskid.ui.impl.mainmenu;
...
import openskid.ui.impl.gui.GuiBackgroundSelector;
...
public class OpenSkidMainMenu extends GuiScreen implements GuiYesNoCallback
{
    private static final AtomicInteger field_175373_f = new AtomicInteger(0);
    private static final Logger logger = LogManager.getLogger();
    private static final Random RANDOM = new Random();
    private float updateCounter;
    private openskid.util.shader.impl.GuiButton buttonResetDemo;
    ...
    private openskid.util.shader.impl.GuiButton altsButton;
    private boolean field_183502_L;
    private GuiScreen field_183503_M;
    private openskid.util.shader.impl.GuiButton modButton;
    private GuiScreen modUpdateNotification;
    private long initTime = System.currentTimeMillis();

    public OpenSkidMainMenu() {
    ...
    private static synchronized void playStartupOnce() {
        ...
        startupPlayed = true;
        try {
            openskid.util.SoundPlayer.play("/assets/openskid/sounds/startup.wav", 60);
    ...
    public void initGui()
    {
        ...
        playStartupOnce();
        openskid.setup.SetupHook.onMainMenu(this);
        ...
        this.buttonList.add(new openskid.util.shader.impl.GuiButton(0, this.width / 2 - 100, j + 72 + 12, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new openskid.util.shader.impl.GuiButton(4, this.width / 2 + 2, j + 72 + 12, 98, 20, I18n.format("menu.quit", new Object[0])));
    ...
    {
        this.buttonList.add(new openskid.util.shader.impl.GuiButton(1, this.width / 2 - 100, p_73969_1_, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new openskid.util.shader.impl.GuiButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("menu.multiplayer", new Object[0])));

        this.buttonList.add(this.altsButton = new openskid.util.shader.impl.GuiButton(14, this.width / 2 + 2, p_73969_1_ + p_73969_2_ * 2, 98, 20, "Alt Manager"));
        this.buttonList.add(this.modButton = new openskid.util.shader.impl.GuiButton(6, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format("fml.menu.mods", new Object[0])));
    }

    private void addDemoButtons(int p_73972_1_, int p_73972_2_)
    {
        this.buttonList.add(new openskid.util.shader.impl.GuiButton(11, this.width / 2 - 100, p_73972_1_, I18n.format("menu.playdemo", new Object[0])));
        this.buttonList.add(this.buttonResetDemo = new openskid.util.shader.impl.GuiButton(12, this.width / 2 - 100, p_73972_1_ + p_73972_2_ * 1, I18n.format("menu.resetdemo", new Object[0])));
