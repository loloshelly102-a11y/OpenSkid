package openskid.ui.impl.gui;

import openskid.config.MenuConfig;
import openskid.util.RenderUtil;
import openskid.util.shader.ShaderUtil;
import openskid.util.shader.impl.MainMenu;
...
public final class BackgroundRenderer {
    ...
    public static final int BACKGROUND_OPENSKID_PLUS = 1;
    public static final int BACKGROUND_CARD = 2;
