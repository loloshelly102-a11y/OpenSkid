...
public class TeamUtil {
    ...
    public static boolean isFriend(EntityPlayer player) {
        return player != null && OpenSkid.friendManager != null && OpenSkid.friendManager.isFriend(player.getName());
    }

    public static boolean isTarget(EntityPlayer player) {
        return player != null && OpenSkid.targetManager != null && OpenSkid.targetManager.isFriend(player.getName());
    }
}
