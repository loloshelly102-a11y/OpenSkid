...
public class ShaderUtils {
    ...
    private final String roundedRect = "#version 120\n" +
            ...
            "\n" +
            "}";
    private final String roundedRectCard = "#version 120\n" +
            "\n" +
            "uniform vec2 u_size;\n" +
        ...
        try {
            ...
            switch (fragmentShaderLoc) {
                ...
                case "roundedRectGradient":
                    ...
                    break;
                case "roundedRectCard":
                    fragmentShaderID = createShader(new ByteArrayInputStream(roundedRectCard.getBytes()), GL_FRAGMENT_SHADER);
                    break;
                default:
