...
public final class CardBloomShader {
    ...
    private static boolean ensureProgram() {
        ...
        if (GL20.glGetProgrami(programId, GL20.GL_LINK_STATUS) == 0) {
            System.err.println("Card bloom shader failed to link: " + GL20.glGetProgramInfoLog(programId, 4096));
    ...
    private static int compileShader(String source, int type) {
        ...
        if (GL20.glGetShaderi(shader, GL20.GL_COMPILE_STATUS) == 0) {
            System.err.println("Card bloom shader failed to compile: " + GL20.glGetShaderInfoLog(shader, 4096));
    ...
    private static void updateKernel(int radius) {
        ...
        float[] kernel = CardGaussianKernel.compute(radius);
