...
public class ChatUtil {
    ...
    private static boolean hasClientPrefix(String message) {
        String formattedPrefix = ChatColors.formatColor(OpenSkid.clientName);
        return message.startsWith(OpenSkid.clientName) || message.startsWith(formattedPrefix) || message.startsWith(ChatColors.PREFIX_CLEAN);
    }

    private static Object[] prependClientName(Object[] objects) {
        Object[] result = new Object[objects.length + 1];
        result[0] = OpenSkid.clientName;
