...
public class AccountManager {
    ...
    private static final File file = new File(mc.mcDataDir, "openopenskid.accounts.json");
            ...
            try {
                if (file.getParentFile().exists() || file.getParentFile().mkdirs()) {
                    if (file.createNewFile()) {
                        System.out.print("Successfully created openopenskid.accounts.json!");
                    }
                }
            } catch (IOException e) {
                System.err.print("Couldn't create openopenskid.accounts.json!");
            }
        }
    }
    ...
    public static void load() {
        ...
        try {
            ...
            System.err.print("Couldn't find openopenskid.accounts.json!");
        }
    }
    ...
    public static void save() {
        try {
            ...
            System.err.print("Couldn't save openopenskid.accounts.json!");
        }
    }
}
